...
K1: float = 1.2
B: float = 0.75
DATA_DIR = Path(r"C:\Users\eveli\OneDrive - Rīgas Tehniskā Universitāte\thesis\Stemming\data1")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    group.add_argument("--ngram", action="store_true", help="character n-grams")
...
def resolve_normaliser(args: argparse.Namespace) -> Callable[[List[str]], List[str]]:
    ...
    if args.ngram: return ngram_tokens
